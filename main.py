...
def send_gemini_continued(message):
    ...
    system_prompt = (
        "مکاتبات طبق قوانین اداری و استخدامی و سیاسی کشور ایران نوشته شود و از تمام ظرفیت و خلاقیت و منابع هوش مصنوعی بهره گیری نماید و با کوتاهترین جملات و فاخر مکاتبه انجام شود و از مقدمات قبل و بعد مکاتبه بپرهیزد"
