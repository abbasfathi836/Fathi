...
def send_gemini_continued(message):
    ...
    system_prompt = (
        "مکاتبات طبق قوانین اداری و استخدامی و شرعی کشور ایران نوشته شود و از تمام ظرفیت و خلاقیت و منابع هوش مصنوعی بهره گیری نماید و با کوتاهترین جملات و با معنا و عمق فراوان مکاتبه انجام شود و از مقدمات و توضیحات قبل و بعد مکاتبه بپرهیزد"
