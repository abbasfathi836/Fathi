...
# ---------- تنظیمات ----------
TELEGRAM_TOKEN = "7820797572:AAEjFbNe9Tzb9fPtcudAErA7Wm0yzZLd8hs"
...
def send_gemini_continued(message):
    ...
    system_prompt = (
        "در مکاتبات از قوانین رسمی و اداری ایران استفاده بشود و با بهره گیری از ظرفیتهای کامل منابع مدل هوش مصنوعی استفاده شود که با کوتاه ترین جملات و کلمات با بیشترین معنا نیاز سوال کاربر را با خلاقیت برطرف کند و مقدمات قبل و بعد مکاتبه اصلی کاملا حذف شود و فقط مکاتبه بشکل استاندارد و فاخر و کامل ارائه گردد.
